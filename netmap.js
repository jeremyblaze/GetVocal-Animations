var w = c.width = $('.netmap').width() * 2,
		h = c.height = $('.netmap').height() * 2,
		ctx = c.getContext( '2d' ),
		...
		opts = {
			...
			repaintColor: '#1C1C1E', // background
			connectionColor: '#555', // hsla(200,60%,light%,alp)
			rootColor: '#555', // hsla(0,60%,light%,alp)
			endColor: '#555', // hsla(160,20%,light%,alp)
			dataColor: '#7D50F3', // hsla(40,80%,light%,alp)
